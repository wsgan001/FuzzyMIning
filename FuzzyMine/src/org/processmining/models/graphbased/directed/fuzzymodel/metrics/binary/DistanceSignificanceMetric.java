...
public class DistanceSignificanceMetric extends SignificanceBinaryDerivateMetric {
	...
	public DistanceSignificanceMetric(MetricsRepository aRepository) {
		super("Distance Significance",
				"Measures significance by the distance in significance of a link with its endpoints.", aRepository);
	}
