...
public class FrequencySignificanceUnaryMetric extends UnaryLogMetric {
	...
	public FrequencySignificanceUnaryMetric(int aNumberOfEvents) {
		super("Frequency significance metric", "Measures the significance of events by their relative frequency",
				aNumberOfEvents);
	}
	 ...
	 * @param aNumberOfEvents
	 */
	public FrequencySignificanceUnaryMetric() {
		super("Frequency significance metric", "Measures the significance of events by their relative frequency");
	}
	 ...
	 * 
	 * @see
	 * org.processmining.mining.fuzzymining.metrics.UnaryLogMetric#measureImpl
	 * (org.processmining.framework.log.AuditTrailEntry)
	 */
	protected double measureImpl(XEvent ate) {
